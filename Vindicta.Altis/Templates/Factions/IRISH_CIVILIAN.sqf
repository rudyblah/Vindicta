...
_array set [T_NAME, "tIRACivilian"];
_array set [T_DESCRIPTION, "Irish Civilians."];
_array set [T_DISPLAY_NAME, "Irish Civilians"];
...
_inf set [T_INF_exp, [
    "IRA_CIVILIAN_Saboteur_1"
]];
_inf set [T_INF_survivor, [
    "IRA_CIVILIAN_Militant_1"
]];
