...
_array set [T_NAME, "tUsPolice"];
_array set [T_DESCRIPTION, "Misfit Tactical's American-Aligned Police."];
_array set [T_DISPLAY_NAME, "Misfit US Police"];
...
_inf set [T_INF_SL, ["US_POLICE_1", "US_POLICE_2", "US_POLICE_3", "US_POLICE_4", "US_POLICE_5", "US_POLICE_6", "US_POLICE_7", "US_POLICE_8"]];
_inf set [T_INF_TL, ["US_POLICE_1", "US_POLICE_2", "US_POLICE_3", "US_POLICE_4", "US_POLICE_5", "US_POLICE_6", "US_POLICE_7", "US_POLICE_8"]];
_inf set [T_INF_officer, ["US_POLICE_1", "US_POLICE_2", "US_POLICE_3", "US_POLICE_4", "US_POLICE_5", "US_POLICE_6", "US_POLICE_7", "US_POLICE_8"]];
/*
